...
Rails Girls was founded in end of 2010 in Helsinki. Originally intended as a onetime event. We never thought see so many local chapters all around the world.The guide has been put together to help you to get started.
...
Wrap the keyboard shortcuts with [kbd](https://www.w3.org/wiki/HTML/Elements/kbd) HTML tag.

Make the posts consistent in style, you can use `Ctrl+C` over `CTRL-c`/`ctrl+c`
